...
/* To be compatible with CMSIS RTE (retargeting files will be copied to the local RTE folder),
   check the toolchain dependent retarget_XXX.c with __has_include macro to prevent compiler error. */
    ...
    #ifndef NVT_ISP_FUNC
        #if __has_include("../../Device/Nuvoton/M5531/Source/GCC/retarget_GCC.c")
            #include "../../Device/Nuvoton/M5531/Source/GCC/retarget_GCC.c"
        #endif
    #else
        // To reduce code size
    #endif
...
#if defined (__ARMCC_VERSION)
    #if __has_include("../../Device/Nuvoton/M5531/Source/ARM/retarget_ARMCC.c")
        #include "../../Device/Nuvoton/M5531/Source/ARM/retarget_ARMCC.c"
    #endif
#endif

#if defined (__ICCARM__)
    #if __has_include("../../Device/Nuvoton/M5531/Source/IAR/retarget_ICC.c")
        #include "../../Device/Nuvoton/M5531/Source/IAR/retarget_ICC.c"
    #endif
#endif
